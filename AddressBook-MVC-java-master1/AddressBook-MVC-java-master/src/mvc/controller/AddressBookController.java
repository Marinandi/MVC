...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String college = contactDetailsPanel.getCollegeField().getText();
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,college);
   ...
   */
    ...
    public Boolean validate(){
        ...
        String email = contactDetailsPanel.geteMailField().getText();
        String college = contactDetailsPanel.getCollegeField().getText();
        if (name==null||name.equals("")||(mobile==null||mobile.equals("")||(email==null||email.equals("")||(college==null||college.equals("")))))
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setCollege(detailPanel.getCollegeField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.geteMailField().setEditable(false);
          detailPanel.getCollegeField().setEditable(false);
        }
    }  //loadPersons ends
